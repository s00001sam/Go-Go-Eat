...
import com.sam.gogoeat.databinding.ItemCollapseAllBinding

class CollapseStoreAdapter(private val onClickListener: OnclickListener) : ListAdapter<GogoPlace, CollapseStoreAdapter.ViewHolder>(DiffCallback) {
    ...
    class ViewHolder(private val binding: ItemCollapseAllBinding, private val context: Context) :
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = ItemCollapseAllBinding.inflate(layoutInflater, parent, false)
